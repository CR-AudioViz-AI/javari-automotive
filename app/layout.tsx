// app/layout.tsx — Javari Automotive · CR AudioViz AI · EIN: 39-3646201 · May 2026
import type { Metadata } from 'next'
import './globals.css'
export const dynamic = 'force-dynamic'
export const metadata: Metadata = {
  metadataBase: new URL('https://automotive.craudiovizai.com'),
  ...
  openGraph: { images: [{ url: '/og-image.png', width: 1200, height: 630 }], title: 'Javari Automotive | CR AudioViz AI', description: 'AI automotive tools — vehicle data, market values, maintenance.', type: 'website' },
}
      ...
      <body style={{ margin:0,padding:0,fontFamily:'system-ui' }}>
        ...
        <footer style={{ background:'#050608',borderTop:'1px solid rgba(255,255,255,0.05)',padding:'16px 24px',textAlign:'center' }}>
          <p style={{ color:'#1f2937',fontSize:11,margin:0 }}>
            © 2026 CR AudioViz AI, LLC — EIN: 39-3646201 · Fort Myers, FL · <a href="https://craudiovizai.com" style={{ color:'#374151',textDecoration:'none' }}>craudiovizai.com</a> · <a href="https://craudiovizai.com/auth/signup" style={{ color:'#f59e0b',textDecoration:'none',fontWeight:600 }}>Sign Up Free</a>
          </p>
        </footer>
      </body>
    </html>
